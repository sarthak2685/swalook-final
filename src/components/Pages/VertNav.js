    ...
    >
      ...
      <div className="nav-items flex flex-col gap-6 mt-2 mb-5 overflow-y-auto mx-8 ">
        <NavItem
          ...
          onClick={() =>
            handleLinkClick("dashboard", `/${sname}/${branchName}/dashboard`)
          }
        />
        <NavItem
        ...
        <NavItem
          ...
          onClick={() =>
            handleLinkClick("invoices", `/${sname}/${branchName}/generatebill`)
          }
        />
        <NavItem
        ...
        {userType !== "staff" && (
          <NavItem
            ...
            onClick={() =>
              handleLinkClick("staff", `/${sname}/${branchName}/staff`)
            }
          />
        )}
        <NavItem
          ...
          onClick={() =>
            handleLinkClick("attendance", `/${sname}/${branchName}/attendance`)
          }
        />
        <NavItem

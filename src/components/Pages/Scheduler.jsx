...
const Scheduler = () => {
  ...
  const timeSlots = Array.from({ length: 24 }, (_, index) => {
    ...
    return {
      label: `${
        formattedHour < 10 && hour < 12 ? "0" + formattedHour : formattedHour
      }:00 ${period}`,
      value: hour,
    };
  });
  ...
  const handleCreateInvoice = () => {
    if (selectedAppointment) {
      ...
      navigate(invoiceUrl, { state: { appointment: selectedAppointment } });
    }
  };
        ...
        {selectedAppointment ? (
          <div className="flex flex-col items-center">
            ...
            >
              ...
              <p className="text-gray-700">
                <strong>Date Of Aniversary:</strong> {selectedAppointment.d_o_a}
              </p>
              <p className="text-gray-700">
                <strong>Date Of Birth:</strong> {selectedAppointment.d_o_b}
              </p>
              <p className="text-gray-700">
              ...
              <p className="text-gray-700">
                <strong>Schedule Time:</strong> {selectedAppointment.time}
              </p>
              <p className="text-gray-700">

            ...
            <Router>
                <Routes>
                    ...
                    <Route element={<PrivateRoute />}>
                        ...
                        <Route
                            path="/:salon_name/owner"
                            element={<OwnerDashboard />}
                        />
                        <Route
                            path="/:salon_name/:branchName/dashboard"
                            element={<AdminDashboard />}
                        />
                        <Route
                            path="/:salon_name/:branchName/service"
                            element={<ServiceDetails />}
                        />
                        <Route
                            path="/:salon_name/:branchName/settings"
                            element={<Settings />}
                        />
                        <Route
                            path="/:salon_name/:branchName/appointment"
                            element={<Appointment />}
                        />
                        <Route
                            path="/:salon_name/:branchName/settings/personalInformation"
                            element={<PersonalInformation />}
                        />
                        <Route
                            path="/:salon_name/:branchName/generatebill"
                            element={<GenerateInvoice />}
                        />
                        <Route
                            path="/:salon_name/:branchName/view-all-invoices"
                            element={<ViewAllInvoices />}
                        />
                        <Route
                            path="/:salon_name/:branchName/:slno/invoice"
                            element={<Invoice />}
                        />
                        <Route
                            path="/:salon_name/:branchName/viewinvoice/:id"
                            element={<ViewInvoice />}
                        />
                        <Route
                            path="/:salon_name/:branchName/analysis"
                            element={<BusinessAnalysis />}
                        />
                        <Route
                            path="/:salon_name/:branchName/help"
                            element={<Help />}
                        />
                        <Route
                            path="/:salon_name/:branchName/generatebil"
                            element={<AppointAsInv />}
                        />
                        <Route
                            path="/:salon_name/:branchName/inventory"
                            element={<Inventory />}
                        />
                        <Route
                        ...
                        />
                        <Route
                            path="/:salon_name/:branchName/staff"
                            element={<AdminManagement />}
                        />
                        <Route
                            path="/:salon_name/:branchName/staffSettings"
                            element={<StaffSetting />}
                        />
                        <Route
                            path="/:salon_name/:branchName/expense"
                            element={<ExpensesManagement />}
                        />
                        <Route
                            path="/:salon_name/:branchName/expenseSetting"
                            element={<ExpenseSetting />}
                        />
                        <Route
                            path="/:salon_name/:branchName/demo"
                            element={<Damo />}
                        />
                        <Route
                            path="/:salon_name/:branchName/customer-loyality"
                            element={<CustomerLoyality />}
                        />
                        <Route
                            path="/:salon_name/:branchName/view-all-Appointments"
                            element={<AllAppointment />}
                        />
                        <Route
                            path="/:salon_name/:branchName/inquiries"
                            element={<Inquiries />}
                        />
                        <Route
